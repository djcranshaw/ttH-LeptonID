...
void
EGammaMvaEleEstimatorFWLite::initialize( std::string methodName,
      MVAType type,
      ...
      std::vector<std::string> weightsfiles )
{
   ...
   switch(type) {
      case EGammaMvaEleEstimatorFWLite::kTrig:
         pogType = EGammaMvaEleEstimatorCSA14::kTrig;
         break;
      case EGammaMvaEleEstimatorFWLite::kNonTrig:
         pogType = EGammaMvaEleEstimatorCSA14::kNonTrig;
         break;
      case EGammaMvaEleEstimatorFWLite::kNonTrigPhys14:
         pogType = EGammaMvaEleEstimatorCSA14::kNonTrigPhys14;
         break;
      default:
         return;
   }
...
float
EGammaMvaEleEstimatorFWLite::mvaValue(const pat::Electron& ele, bool printDebug)
{
